...
/* readln  added*/
extern int readln(void* buffer);

extern int readchar(void* ch);

extern int createFile(char* fileName, char* targetDir); 

extern int createDirectory(char* fileName, char* targetDir); 

extern int list(char* filelocation);
#endif
